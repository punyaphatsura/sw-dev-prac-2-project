...
export const inputVariant = tv({
    base: [
        ...
        'disabled:bg-disable disabled:text-high disabled:cursor-not-allowed disabled:opacity-80',
        ...
        'group-aria-[invalid=true]:border-error',
        'aria-[invalid=true]:ring-border-error group-aria-[invalid=true]:ring-border-error',
    ],
    variants: {
        variantSize: {
            sm: 'px-3 py-1 h6',
