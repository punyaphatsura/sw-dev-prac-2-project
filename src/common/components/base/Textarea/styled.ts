...
export const textareaVariants = tv({
  base: [
    'flex min-h-[80px] w-full rounded-md border border-input bg-background hover:border-primary',
    'px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground',
    'disabled:cursor-not-allowed disabled:opacity-80 disabled:text-high disabled:hover:!border-default',
    'h5 scrollbar-hide',
